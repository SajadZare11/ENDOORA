...
این سند معماری، مدل‌های داده، قوانین بیزینسی، ماشین وضعیت، سرویس‌ها، اندپوینت‌های امنیتی و رابط‌های کاربری مربوط به **روز ۴۱ از نقشه راه ۶۰ روزه ایندورا** را تشریح می‌کند.

---

## ۱. اهداف و چشم‌انداز محصول
بازارگاه آموزش زبان ایندورا نیازمند زیرساخت‌های نظارتی، داوری عادلانه، راستی‌آزمایی علمی مدرسین و مدیریت متمرکز سیاست‌های قیمت‌گذاری است:
...
2. **پایپ‌لاین ارزیابی مدارک و تایید صلاحیت اساتید (Teacher Onboarding Approval Pipeline)**:
   دریافت اطلاعات هویتی و مدارک رسمی مدرسین (کد ملی، تصویر کارت شناسایی، دانشنامه دانشگاهی، مدارک معتبر بین‌المللی نظیر CELTA، TESOL، DELTA یا TTC و لینک نمونه تدریس ویدیویی)؛ همراه با پرتال اختصاصی مدرس و صف ارزیابی کارشناسان ایندورا با قابلیت تایید نهایی، درخواست اصلاح مدارک و سوییچ دسترسی بازارگاه (`marketplace_eligible`).
...
2. **پرتال تایید صلاحیت و احراز هویت مدرسین (`apps/web/app/(teacher)/teacher/verification/page.tsx`)**:
   ...
   - گام‌های شفاف فرایند ارزیابی و استانداردهای کیفی تدریس در ایندورا.
...
- استفاده صفر از رنگ‌های هگز خام (Zero raw hex: استفاده منحصربه‌فرد از توکن‌های متغیر سامانه طراحی ایندورا).
