...
پلتفرم ایندورا از زنجیره نظارت یکپارچه‌ای استفاده می‌کند که از درگاه فرانت‌اند Next.js آغاز شده و از طریق میدل‌ویر اختصاصی `CorrelationTraceMiddleware` تا لایه‌های سرویس Django، کلاستر پایگاه داده PostgreSQL 16، حافظه نهان Redis Sentinel و درگاه هوش مصنوعی امتداد می‌یابد.
...
زیرسیستم اعلان‌های ایندورا (`/account/notifications`) به صورت چندکاناله طراحی شده است:
