...
این سند معماری تفصیلی، پروتکل‌های نظارتی، مکانیسم‌های بازدارنده تاب‌آوری (Circuit Breaker) و رویه‌های مدیریت نسخه‌بندی پرامپت‌های پلتفرم ایندورا را بر پایه مشخصات معماری **OPS-005** تبیین می‌نماید.

---

### ۱. معماری دروازه هوش مصنوعی و آبشار تاب‌آوری مدل‌ها (Model Router & Fallback Cascade)

دروازه هوش مصنوعی ایندورا (`ai_gateway`) وظیفه دارد تعاملات زیرسیستم‌های هوشمند پلتفرم (آزمون تعیین سطح، ارزیابی نوشتار، تحلیل تلفظ و آزمایشگاه صوت، سناریوهای نقش‌آفرینی زنده و تولید تمارین تطبیقی) را با اطمینان ۹۹.۵٪ و حداقل تاخیر مدیریت نماید.

```mermaid
graph TD
    Client[ماژول‌های آموزشی ایندورا: رایتینگ، اسپیکینگ، تعیین‌سطح، رول‌پلی] --> Gateway[LLM Gateway Service]
