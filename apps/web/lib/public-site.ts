...
export const homeCopy: Localized<{
  ...
  fa: {
    ...
    loopSteps: [
      "۱. ورود و هدف‌گذاری آموزشی",
      "۲. آزمون تعیین سطح ۶ مهارتی",
      "۳. کارنامه تحلیلی CEFR",
      "۴. مسیر اختصاصی و کتاب آموزشی",
      "۵. ثبت‌نام در کلاس آنلاین زنده",
      "۶. ماموریت روزانه انطباقی (تکلیف + SRS)",
      "۷. آزمایشگاه‌های تمرین عمیق AI",
    ],
  ...
  en: {
    ...
    loopSteps: [
      "1. Onboarding & Goal Profiling",
      "2. 6-Skill Diagnostic Placement",
      "3. CEFR Diagnostic Report",
      "4. Personalized Path & Textbook Mapping",
      "5. Live Online Class Enrollment",
      "6. Adaptive Daily Mission (Homework + SRS)",
      "7. AI Labs & Deep Practice",
    ],
...
export const publicPages: Record<PublicPageKey, Localized<CopyBlock>> = {
  "how-it-works": {
    fa: {
      ...
      title: "چرخه ۷ مرحله‌ای یادگیری Endoora: از شناخت دقیق تا تسلط کامل",
      summary: "Endoora فرآیند یادگیری زبان انگلیسی را در یک چرخه پیوسته و هوشمند متحد کرده است: ارزیابی، نقشه راه با کتاب‌های استاندارد، کلاس زنده تعاملی، تمرین روزانه اولویت‌دار و آزمایشگاه‌های عمیق هوش مصنوعی.",
      sections: [
        {
          title: "۱. ورود و هدف‌گذاری آموزشی (Onboarding & Profiling)",
          body: "شناخت رده سنی (خردسال ۴-۷، کودک و نوجوان ۸-۱۲، بزرگسال) و هدف اصلی یادگیری (مکالمه عمومی، آزمون‌های بین‌المللی آیلتس/تافل یا مهاجرت) برای شخصی‌سازی از نخستین قدم.",
        },
        {
          title: "۲. آزمون جامع تعیین سطح ۶ مهارتی (6-Skill Placement)",
          body: "ارزیابی چندبُعدی و تطبیقی در مهارت‌های دستور زبان، واژگان، خواندن، شنیداری، گفتاری و نگارش بدون حدس و بدون داده ساختگی.",
        },
        {
          title: "۳. گزارش تحلیلی سطح و کارنامه CEFR (Diagnostic Report)",
          body: "ارائه نمودار تحلیلی نقاط قوت و نیاز به رشد بر مبنای تراز استاندارد بین‌المللی CEFR از مبتدی (A1) تا پیشرفته (C2).",
        },
        {
          title: "۴. مسیر اختصاصی و انتخاب خودکار کتاب آموزشی (Personalized Path & Books)",
          body: "سیستم بر اساس سطح دقیق زبان‌آموز، معتبرترین کتاب درسی استاندارد را اختصاص می‌دهد (American English File Starter تا 5، Family & Friends، Oxford Discover یا منابع تخصصی Cambridge IELTS و Barron's TOEFL) و نمودار مسیر پیشرفت، سرفصل‌ها، گرامر و اهداف مکالمه را نمایش می‌دهد.",
        },
        {
          title: "۵. ثبت‌نام در کلاس آنلاین زنده و اتصال به مدرس (Live Class Enrollment)",
          body: "زبان‌آموز روزها و سانس‌های زمانی آزاد خود و فرمت ترجیحی (انفرادی خصوصی یا گروهی تا ۳ همکلاسی، حداکثر ۴ نفر) را ثبت می‌کند. درخواست به استخر کلاس‌های داشبورد مدرسان ارسال شده و گروه‌های همسطح به‌طور هوشمند تشکیل می‌شوند. مدرس پس از هر جلسه، گزارش تدریس و تکالیف را ثبت می‌کند.",
        },
        {
          title: "۶. ماموریت روزانه انطباقی (Adaptive Daily Mission)",
          body: "تمرین روزانه کوتاه و متمرکز که اولویت اول آن تکالیف کلاسی محول‌شده توسط مدرس در جلسه آنلاین اخیر است، همراه با مرور فاصله‌دار واژگان جدید با الگوریتم SRS.",
        },
        {
          title: "۷. آزمایشگاه‌های هوش مصنوعی و تمرین عمیق (AI Labs & Deep Practice)",
          body: "تمرین نامحدود در مربی نگارش هوشمند (Writing Mentor)، آزمایشگاه صوت و تلفظ (Voice Lab)، شبیه‌ساز مکالمه زنده (AI Roleplay) و تمرین بر اساس ژنوم اشتباهات پرتکرار (Mistake Genome).",
        },
      ],
    },
    en: {
      eyebrow: "How it works",
      title: "The 7-Step Endoora Learning Loop: From Diagnostics to Mastery",
      summary: "Endoora integrates English learning into a unified, evidence-based loop: diagnostic placement, automated textbook mapping, live interactive classes, prioritized daily missions, and AI-powered practice labs.",
      sections: [
        {
          title: "1. Onboarding & Goal Profiling",
          body: "Establish learner age brackets (young learners 4–7, 8–12, or adult) and core goals (General English, IELTS, TOEFL, or migration) to calibrate the roadmap from day one.",
        },
        {
          title: "2. 6-Skill Diagnostic Placement Test",
          body: "Adaptive evaluation spanning Grammar, Vocabulary, Reading, Listening, Speaking, and Writing without synthetic score guesswork.",
        },
        {
          title: "3. Placement Analysis & CEFR Diagnostic Report",
          body: "Detailed radar skill breakdown benchmarked against the international CEFR standard from Beginner (A1) to Advanced (C2).",
        },
        {
          title: "4. Personalized Path & Automated Textbook Mapping",
          body: "The engine automatically maps the learner's diagnosed level to standard coursebooks (American English File Starter to 5, Family & Friends, Oxford Discover, or Cambridge IELTS/Barron's TOEFL) and generates dynamic graphs of present and future milestones.",
        },
        {
          title: "5. Live Online Class Enrollment & Teacher Matching",
          body: "Learners select weekly availability and preferred class format (1-on-1 private or group with up to 3 classmates, max 4 students). Requests appear in the teacher pool where smart cohorts cluster and teachers log lessons and homework.",
        },
        {
          title: "6. Adaptive Daily Mission",
          body: "Daily bite-sized learning rhythm prioritizing the live teacher's homework from the latest session, integrated with spaced-repetition (SRS) vocabulary consolidation.",
        },
        {
          title: "7. AI Labs & Deep Practice",
          body: "Unbounded interactive practice in the AI Writing Mentor, Voice & Pronunciation Lab, situational AI Roleplay, and Mistake Genome drills.",
        },
      ],
    },
  },
  ...
  classes: {
    fa: {
      ...
      summary: "کلاس‌های گروهی با ظرفیت محدود، درخواست مهمان، لیست انتظار هوشمند و ثبت‌نام شفاف تحت نظارت آموزشی.",
      sections: [
