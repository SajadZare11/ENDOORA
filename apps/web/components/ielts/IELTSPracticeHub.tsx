...
export function IELTSPracticeHub() {
  const router = useRouter();

  const [tests, setTests] = useState<IELTSTestListItem[]>(DEFAULT_FALLBACK_TESTS);
      ...
      <div className={styles.container}>
        ...
        <aside className={styles.disclaimerBanner} role="note">
          ...
          <div>
            ...
            <div>
              محتوای این شبیه‌ساز ۱۰۰٪ اورجینال و تولید هیئت علمی ایندورا است و آزمون رسمی نیست.
            </div>
          </div>
        </aside>
        ...
        <div className={styles.controlsBar}>
          <div className={styles.filterGroup}>
            ...
            <Button
              type="button"
              variant={typeFilter === "academic" ? "primary" : "secondary"}
              size="sm"
            ...
            <Button
              type="button"
              variant={typeFilter === "general_training" ? "primary" : "secondary"}
              size="sm"
                ...
                <article key={test.id} className={styles.testCard}>
                  ...
                  <div className={styles.modeSelection}>
                    ...
                    <div className={styles.modeButtons}>
                      <Button
                        type="button"
                        variant={currentMode === "full_simulation" ? "primary" : "secondary"}
                        size="sm"
                      ...
                      <Button
                        type="button"
                        variant={currentMode === "reading_practice" ? "primary" : "secondary"}
                        size="sm"
                      ...
                      <Button
                        type="button"
                        variant={currentMode === "listening_practice" ? "primary" : "secondary"}
                        size="sm"
                      ...
                      <Button
                        type="button"
                        variant={currentMode === "writing_practice" ? "primary" : "secondary"}
                        size="sm"
                      ...
                      <Button
                        type="button"
                        variant={currentMode === "speaking_practice" ? "primary" : "secondary"}
                        size="sm"
